  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_18%_18%,rgba(34,211,238,0.14),transparent_30%),radial-gradient(circle_at_82%_34%,rgba(124,58,237,0.14),transparent_32%),linear-gradient(180deg,#020617_0%,#071122_54%,#020617_100%)]" />
      ...
      <section className="relative z-10 mx-auto max-w-7xl">
        <div className="max-w-3xl">
          <p className="text-sm font-semibold text-cyan-100">من نحن</p>
          <h1 className="mt-4 text-balance text-4xl font-semibold tracking-[-0.04em] text-white sm:text-6xl">
            نبني تجربة تجارة ذكية تناسب المتاجر العربية
          </h1>
          <p className="mt-5 text-lg leading-8 text-[#94A3B8]">
            نساعد المتاجر على تحويل المحادثات اليومية إلى توصيات قابلة للشراء وقرارات مبنية على البيانات.
          </p>
        </div>
      </section>
    </main>
